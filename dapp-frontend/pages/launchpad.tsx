  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        <section className="flex items-center h-[80vh] w-full ">
        ...
        <section className="flex flex-col w-full container h-fit mx-auto pb-14">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="flex flex-col text-center justify-center rounded-[10px] shadow p-8 bg-lightBlue min-h-[200px] max-w-sm">
