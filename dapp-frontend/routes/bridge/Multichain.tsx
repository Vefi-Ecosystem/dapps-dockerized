                ...
                <div className="text-[rgba(255,255,255,0.7)] bg-[#1a1a1a] h-fit px-10 py-10 rounded-[20px] shadow-md">
                    <div className="flex justify-between items-center text-white">
                        ...
                        <div className="flex gap-3">
                            <Image src="/images/wallet.png" alt="wallet" width={25} height={25} onClick={() => setShowDestinationAddress(!showDestinationAddress)} className='' />
                            <Image src="/images/setting.png" alt="wallet" width={25} height={25} />
                        </div>
                    </div>
